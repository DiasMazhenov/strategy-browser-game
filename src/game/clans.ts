...
export const CLANS: Clan[] = [
  {
    ...
    perk: 'скот и загоны',
    desc: 'Приплод чаще (15% шанс двойни), загоны дешевле на 15%, дойка на 15% быстрее',
    mods: { ...NEUTRAL, tel: 1.15, penCost: 0.85 },
  },
  {
    id: 'qypshaq', name: 'Қыпшақ', tamga: 'tamga-qypshaq',
    perk: 'торговля и разведка',
    desc: 'Керуены приносят на 15% больше и ходят на 15% быстрее, барлаушы быстрее',
  ...
  },
  {
    ...
    desc: 'Мудрость копится на 15% быстрее, посланники и дары племенам дешевле на 15%',
    mods: { ...NEUTRAL, wisdom: 1.15, envoy: 0.85 },
  },
  {
    id: 'dulat', name: 'Дулат', tamga: 'tamga-dulat',
    perk: 'добыча и найм',
    desc: 'Добыча на 10% быстрее, войска готовятся на 10% быстрее',
    mods: { ...NEUTRAL, gather: 1.10, train: 1.10 },
  },
];
...
/**
 * Что род ДЖУНГАР реально меняет на поле боя (1.0.131, перевод 1.0.133).
 *
 * Враг получает род из той же таблицы, но экономика ИИ упрощённая: золото
 * капает по формуле, караванов и своей мудрости у него нет. Поэтому множители
 * врага ПЕРЕВЕДЕНЫ на те рычаги, которые у джунгар действительно есть:
 *   tel   (Арғын)  → плотнее волны набегов
 *   train (Дулат)  → люднее стан (больше крестьян)
 *   cavHp/scout/towerHp/build/envoy → применяются напрямую.
 * Перевод, а не «приписать бонус, которого ИИ не получит»: каждый род врага
 * теперь что-то меняет, и это видно в панели дипломатии.
 */
export const RIVAL_NOTE: Record<ClanId, string> = {
  argyn: 'набеги плотнее: +15% воинов в волне',
  ...
  dulat: 'стан люднее: +15% крестьян в его лагере',
};
