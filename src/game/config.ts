...
export const UNIT_DEFS = {
  ...
  monk:        { name: 'Баксы',       hp: 50,  atk: 0,  range: 135, speed: 108, cost: { food: 0, wood: 0, gold: 110 },  trainTime: 14, pop: 1, gather: false, desc: 'Степной знахарь — лечит ваше войско', bld: 'market', ageReq: 0 },
