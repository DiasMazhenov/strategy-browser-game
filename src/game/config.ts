...
export const UNIT_DEFS = {
  ...
  scout:       { name: 'Разведчик',   hp: 60,  atk: 6,  range: 26,  speed: 196, cost: { food: 60, wood: 0, gold: 10 },   trainTime: 8,  pop: 1, gather: false, desc: 'Быстрый: открывает карту, ищет базы племён, обороняется; авто-разведка по карте', bld: 'towncenter', ageReq: 0 },
