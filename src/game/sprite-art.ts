...
export const UNIT_ANCHORS: Record<string, SprAnchor> = {
  ...
  // асыки — ГРУППОВАЯ сценка: метальщик + двое зрителей. Все три кадра лежат на
  // общем холсте 283x157 с одним якорем (по метальщику), поэтому при смене кадра
  // композиция не ездит и фигуры не «дышат».
  "kz_asyk_a":  { "ax": 54.0, "ay": 155, "baseW": 283, "w": 283, "h": 157 },
  "kz_asyk_b":  { "ax": 54.0, "ay": 155, "baseW": 283, "w": 283, "h": 157 },
  "kz_asyk_c":  { "ax": 54.0, "ay": 155, "baseW": 283, "w": 283, "h": 157 }
};
